% Amanda Syamsul
% June 17th 2025
% Correcting for tidally-driven currents using OTPS
...
%% Adjust speeds for current velocities -- Takes a long time. Already saved as table.
...
figure()
plot(adjusted_data.datetime, adjusted_data.velocity, 'o-')
hold on
plot(adjusted_data.datetime, adjusted_data.adjusted_speed, 'g^', 'LineWidth', 2, 'MarkerFaceColor','g')
grid on